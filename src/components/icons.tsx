...
export function TagIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 7h.01M3 7v4.586a2 2 0 00.586 1.414l8.414 8.414a2 2 0 002.828 0l5.172-5.172a2 2 0 000-2.828L11.586 5.586A2 2 0 0010.172 5H5a2 2 0 00-2 2z" />
    </svg>
  )
}
